...
7. **Confirmations on copy** (yes/no each): "since 2016"; "price match"; "every pack splits, mixed patio packs made up in their four sizes" (the current store’s FAQ says only porcelain and Kandla Grey 900 × 600 split; Fee says every pack does, and the demo now follows that — correct the store’s FAQ); "custom orders from 120 m², up to eight weeks"; "Klarna accepted"; sample price £5 (or free / refunded against first order?).
...
10a. **Pack sizes are settled by the warehouse database** (the "stock tracker main · Database Products" sheet). The demo follows it everywhere: mixed sandstone packs 16/16/16/12 (18.19 m²); Kandla Grey 900 × 600 40 slabs (21.60 m²); Black Limestone 22 mm, 38 slabs (13.68 m²); Fossil Mint as the active 900 × 600 pack of 37 slabs (19.98 m²), the mixed pack being marked inactive; 600 × 900 × 20 mm porcelain 40 slabs (21.60 m²); 600 × 600 × 16 mm porcelain 80 slabs in boxes of 2 (28.80 m²); indoor tiles and cladding by the box. What is left:
   - **Store listings to correct** so they match the sheet: Kandla Grey 900 × 600 says 18.90 m²; Black Limestone says 18 m² at 20 mm; Bodo White, Noor Grigio and HS Beige say 28.08 m²; Fossil Mint is listed as a mixed pack; the 16 mm pallets say 28.08.
   - **Sinai Pearl is not in the sheet.** The demo assumes 50 slabs of 600 × 600 = 18 m². Add it to the sheet and the site follows.
   - **Names that differ** between the sheet and the shop, mapped by size and thickness: the 16 mm 600 × 600 Beige, Light Grey and Black pallets are taken to be the sheet's Clorado Light Summer, Dusk Grey and Light Midnight; Aspire Grey is taken to be Aspire Anthra (280 a pallet, 5 a box); Miracle Statuario, Brit Raven, Dark Stonella and Rovero Dark Grey have no row and use the standard indoor packing. A name tidy in the sheet removes the guesswork.
   - The sheet's **steps, edging, granite setts, cobbles, Joint-Tec and Por-Tec jointing compounds and primer** are now on the site as an Essentials page (and as "Finish the job" under each sandstone, limestone and porcelain product), with the packing from the sheet and **no price**: a customer adds one to the bag as a request and the yard rings with the price. **Prices for these fifteen lines** turn the request into an ordinary product; they are the one thing missing.
10b. **Split packs and cutting** (from the Royale Stones study): they charge **£80 handling on split pallets** and offer a **paid cutting service**; they also sell the mixed patio pack in **5 m² and 10 m² sizes** at a higher per-m² price. The demo splits every pack into whole packs plus loose slabs (mixed packs in their four sizes) with no fee shown ("confirmed with the delivery cost"). Does the yard charge for a split pack? Cut to size? Sell part packs?
10d. **Cladding names**: the store lists cladding once with six colourway photographs and no names. The demo now sells each colourway as its own product, named by what is in the photograph: Buff Mix, Silver Quartz, Mint, Slate Green, Kandla Grey, Pale Grey. The warehouse sheet names four cladding lines (Mandawar, Kandla Grey, Jack Black, Rock Face Mint). Tell us which photograph is which and the names change.
10e. **3D view**: every product page now has "See it in 3D": one slab or the stone laid in its pattern (a wall for cladding), dry or wet. The face is the product photograph wrapped on the stone, so it is only as good as the photograph: the straight-down slab photos on the yard list (item 1) will sharpen it, and the hosed photos replace the simulated wet look.
