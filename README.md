...
- **Handover**: `HANDOVER.md` (Coleisha and the company), `DEPLOY.md` (GitHub transfer, Cloudflare, go-live), `OPTIONS.md` (what the yard still owes), `COMPETITOR.md` (Royale Stones), `UPDATES.md` (since the meeting), `web/AUDIT.md` (what has been checked).
- **The stock system**: `wms/` (plan, seed list, shared pack maths, the Worker API over D1). `wms/PLAN.md` first, then `wms/api/README.md`.
