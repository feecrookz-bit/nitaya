    ...
    <>
      ...
      <footer><div className="wrap">
        <div className="foot">
          ...
          <div><h2 className="foot-h">Shop</h2>{CATS.map(([k, l]) => <a key={k} href={href('shop?cat=' + k)}>{l}</a>)}<a href={href('shop?cat=offers')}>Offers</a><a href={href('samples')}>Samples</a><a href={href('essentials')}>Essentials</a></div>
          <div><h2 className="foot-h">Help</h2><a href={href('trade')}>Trade accounts</a><a href={href('projects')}>Projects</a><a href={href('about')}>About the yard</a><a href={href('guides')}>Guides</a><a href={href('build')}>Build your patio</a><a href={href('collections')}>Collections</a><a href={href('faq')}>FAQ</a><a href={href('about')}>Ordering &amp; delivery</a><a href={href('about')}>Laying patterns</a><a href={href('contact')}>Contact</a></div>
          <div><h2 className="foot-h">The yard</h2><a href={BUSINESS.phoneHref}>{BUSINESS.phone}</a><a href={BUSINESS.mobileHref}>{BUSINESS.mobile}</a><a href={'mailto:' + BUSINESS.email}>{BUSINESS.email}</a><a href={BUSINESS.maps} target="_blank" rel="noreferrer">{BUSINESS.address.join(', ')}</a><span style={{ display: 'block', paddingTop: 3 }}>{BUSINESS.hoursShort}</span>
