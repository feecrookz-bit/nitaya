...
export const GUIDES = [
  {
    ...
    sections: [
      { h: 'What you’re actually choosing between', p: ['Sandstone is quarried, hand-split rock. Every slab is different and the face is riven, rising and falling a few millimetres even though the slab is calibrated underneath. Porcelain is pressed clay fired until it turns glassy: dead flat, calibrated, and identical slab to slab.', 'Neither is “better”. They behave differently, and they suit different gardens and different budgets for the work, not just the stone.'] },
      { h: 'Where sandstone wins', p: ['Character: no two slabs match, and the colour deepens when it’s wet. It suits older houses, brick, and planting that spills over edges. It’s also more forgiving to lay by hand: a riven slab on a full mortar bed hides a slightly uneven base.', 'Cost of the stone is the same as our porcelain per m², but sandstone doesn’t need a primer slurry or a rectified-joint finish, so the labour is usually cheaper.'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Bed', p: ['Riven sandstone is calibrated to 22 mm, but the riven face still rises and falls by a few millimetres across a slab. That’s why it goes on a full wet bed of 4:1 sharp sand to cement, 30–40 mm thick, never on dabs. Dabs leave voids that hold water, freeze and lift the slab.', 'Prime the back of every slab with an SBR or proprietary primer slurry before it goes down. It bonds the stone to the bed and stops the picture-framing you see on patios laid dry.'] },
  ...
  },
  {
    ...
    sections: [
      { h: 'Timing', p: ['Three to five working days from cleared payment. We call on the morning of delivery. The lorry arrives between 8am and 6pm, and someone needs to be there to sign.'] },
